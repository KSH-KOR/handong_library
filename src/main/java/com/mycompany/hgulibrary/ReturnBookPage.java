...
public class ReturnBookPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(selectedRowNum != -1) {
            Observer_first observer_first = new ImpleObserver_first();
            Subject_first subjectfirst = new ImpleSubject(observer_first);
            subjectfirst.notifyObserver();
            ...
            JOptionPane.showMessageDialog(rootPane, "No selected Book");
        }
